...
module.exports = {
    ...
    async cleanup(broker) {
        ...
        await this.deleteAllViaApi('queues', { ignoreAutoGenerated: false });
        await this.deleteAllViaApi('exchanges', { ignoreAutoGenerated: true });
    ...
    async deleteAllViaApi(entityType, { addDefaultVhost = true, ignoreAutoGenerated = true } = {}) {
    ...
    async deleteViaApi(entityType, name, { addDefaultVhost = true } = {}) {
        let vhost = addDefaultVhost ? encodeURIComponent('/') + '/' : '';
